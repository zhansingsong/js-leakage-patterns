...
> singsong: 本文不是原创文，毕竟这方面的知识都偏底层了。文本是自己看了一些不错资料整理出来的，对该知识点感兴趣的同学可以查看[参考文章](#references)小节。
...
* [RenderObject tree(也称为 Render tree)](#renderobject-tree-render-tree)
* [Layout(布局)](#layout)
* [RenderLayer tree](#renderlayer-tree)
* [Rendering(渲染方式)](#rendering)
* [GrphicsLayer tree](#grphicslayer-tree)
* [Tiled Rendering(瓦片渲染)](#tile-rendering)
* [High Performance Animations(流畅动画)](#high-performance-animations)
* [Summary(总结)](#summary)
* [References(参考文章)](#references)
...
![cssom-tree.png](./images/cssom-tree.png)
...
![](./images/the_compositing_forest.png)
